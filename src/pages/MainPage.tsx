          ...
          <Row gutter={[40, 40]} align="middle">
            <Col xs={24} sm={12}>
              ...
              >
                ...
                , chúng tôi cam kết mang đến các liệu trình chăm sóc da chuyên
                sâu, được thiết kế riêng cho từng loại da.
              </Paragraph>
          ...
          {experts.map((expert) => (
            <Col xs={24} sm={12} md={8} lg={6} key={expert.id}>
              ...
              >
                <Title
                  level={4}
                  style={{ marginBottom: "5px", color: "#3A5A40" }}
                >
                  {expert.name}
                </Title>
                <Text strong style={{ color: "#6B705C" }}>
                  {expert.expertise}
                </Text>
                <br />
