        ...
        <Col xs={24} md={10}>
          ...
          >
            {selectedDate ? (
                            ...
                            <Space>
                              {expert.availableHours.map((time) => (
                                <Button
                                  key={time}
                                  type={
                                    selectedExpert === expert.id && selectedTime === time
                                      ? "primary"
                                      : "default"
                                  }
                                  onClick={() => handleSelectExpert(expert.id, time)}
                                  style={{
                                    borderRadius: "20px",
                                    fontSize: "14px",
                                    padding: "8px 16px",
              ...
              <Text style={{ color: "#888" }}>Vui lòng chọn ngày trên lịch để xem lịch làm việc.</Text>
            )}
            ...
            {selectedExpert && (
              <div style={{ marginTop: "20px" }}>
                ...
                <Text>
                  Bạn đã chọn{" "}
                  <strong>{skincareExperts.find((e) => e.id === selectedExpert)?.name}</strong> vào lúc{" "}
                  <strong>{selectedTime}</strong> ngày <strong>{selectedDate}</strong>.
                </Text>
                <div style={{ marginTop: "20px" }}>
                  <Button
                    type="primary"
